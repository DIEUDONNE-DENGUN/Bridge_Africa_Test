                  ...
                  <div class="row">
                      <div class="col-md-6">
                          <div class="list-group">
                              ...
                              <a href="{{url('add_product')}}" class="list-group-item list-group-item-action">Add Product</a>
                              <a href="{{route('products')}}" class="list-group-item list-group-item-action">View Products</a>
